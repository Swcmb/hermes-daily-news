...
TECH_AI_SOURCES="arxiv_cs_ai,arxiv_cs_lg,github_ai,hn,producthunt,reddit_ml,kr_ai,techcrunch_ai"
...
KR_AI_URL="https://rsshub.rssforever.com/36kr/newsflashes"
TECHCRUNCH_AI_URL="https://techcrunch.com/category/artificial-intelligence/feed"

# ===== AI 关键词(用于 news_filter parser 过滤 36kr AI 相关条目) =====
AI_KEYWORDS="AI,LLM,大模型,GPT,Agent,融资,OpenAI,Google,Anthropic,人工智能,机器学习,深度学习,芯片,算力,AGI"

# ===== 推送目标 =====
QQ_TARGET="qqbot:YOUR_BOT_TOKEN_HERE"
